...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        ListSection qualification = new ListSection("JEE AS: GlassFish (v2.1, v3), OC4J, JBoss, Tomcat, Jetty, " +
                ...
                "Python: Django.", "Python: Django.", "JavaScript: jQuery, ExtJS, Bootstrap.js, underscore.js",
...
//      experience at companies
        Period experience1 = new Period("10/2013 - ", "Now", "Создание, " +
                "организация и проведение Java онлайн проектов и стажировок.");
        Company Exp1 = new Company("Java Online Projects", "Автор проекта.", experience1);

        Period experience2 = new Period("10/2014 - ", "01/2016", "Проектирование и разработка " +
        ...
        Company Exp2 = new Company("Wrike", "Старший разработчик (backend)", experience2);

        Period experience3 = new Period("04/2012 - ", "10/2014", "Организация процесса " +
        ...
        Company Exp3 = new Company("RIT Center", "Java архитектор", experience3);

        Period experience4 = new Period("12/2010 - ", "04/2012", "Участие в проекте Deutsche " +
        ...
        Company Exp4 = new Company("Luxoft (Deutsche Bank)", "Ведущий программист", experience4);

        Period experience5 = new Period("06/2008 - ", "12/2010", "Дизайн и имплементация " +
        ...
        Company Exp5 = new Company("Yota", "Ведущий программист", experience5);

        Period experience6 = new Period("03/2007 - ", "06/2008", "Реализация клиентской " +
                "(Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) частей кластерного J2EE приложения" +
                " (OLAP, Data mining).");
        Company Exp6 = new Company("Enkata", "Разработчик ПО", experience6);

        Period experience7 = new Period("01/2005 - ", "02/2007", "Разработка информационной " +
                "модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage " +
                "(Java, Unix).");
        Company Exp7 = new Company("Siemens AG", "Разработчик ПО", experience7);

        Period experience8 = new Period("09/1997 - ", "01/2005", "Тестирование, отладка, " +
                "внедрение ПО цифровой телефонной станции Alcatel 1000 S12 (CHILL, ASM).");
        Company Exp8 = new Company("Alcatel", "Инженер по аппаратному и программному тестированию", experience8);
...
//      education at institutions
        ...
        Company Educ5 = new Company("Санкт-Петербургский национальный исследовательский университет информационных" +
                " технологий, механики и оптики", education5);

        Period education6 = new Period("09/1987 -", "07/1993", "Инженер (программист Fortran, C)");
        Company Educ6 = new Company("Санкт-Петербургский национальный исследовательский университет информационных" +
                " технологий, механики и оптики", education6);

        Period education7 = new Period("09/1984 -", "06/1987", "Закончил с отличием");
        Company Educ7 = new Company("Заочная физико-техническая школа при МФТИ", education7);
        ...
        Resume resume = new Resume("1", "Григорий Кислин", sections,
                contacts);
    ...
    static <V, K> void printResume(Map<K, V> T) {
